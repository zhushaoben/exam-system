<template>
  <div class="app-container">
    <div id="cnblogs_post_body" class="blogpost-body blogpost-body-html">
      ...
      <p>一款多角色在线培训考试系统，系统集成了用户管理、角色管理、部门管理、题库管理、试题管理、试题导入导出、考试管理、在线考试、错题训练等功能，考试流程完善。</p>
      ...
      <p>系统完善：完善的权限控制和用户系统<br>权限控制：基于Shiro和JWT开发的权限控制功能。    <br>用户系统：用户管理、部门管理、角色管理等。    </p>
      <p>多角色：多角色支持    <br>考试端：学生角色、支持在线考试、查看分数、训练错题。    <br>管理端：题库管理、试题管理、考试管理、用户小组管理、查看考试情况等等。    </p>
